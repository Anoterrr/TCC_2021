            ...
            <div class="w-75 p-3 border justify-items-center justify-content-center">
              ...
              <form class="row g-3" action="../../core/cadastroUsuario.php" method="POST">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" name="cpf" class="form-control" id="inputCity" maxlength="11" required/>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-12">
                  ...
                  <input type="text" name="rua" class="form-control" id="rua" placeholder="" maxlength="100" required/>
                </div>
                <div class="col-md-2">
