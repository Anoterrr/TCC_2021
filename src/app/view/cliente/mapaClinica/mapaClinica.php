                        ...
                        <tbody>
                            <tr>
                                ...
                                foreach ($result as $data) {
                                    ...
                                    <td><a href="https://www.google.com.br/maps/place/ ' . $data['rua'] . ',+' . $data['numero'] .' +-+ ' . $data['bairro'] . ',+' . $data['cidade'] . '+-+' . $data['uf'] . '"target="_blank"><button class="border"><img src="" alt="Map"></button></a></td>
