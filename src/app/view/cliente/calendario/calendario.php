    ...
    <section>
      <div class="calendar">
        <div style="display: flex; width: 100%;">
          ...
          <button class="btn" data-bs-toggle="collapse" href="#multiCollapseKid" role="button" aria-expanded="false"
            aria-controls="multiCollapseKid">
          ...
          <button class="btn" data-bs-toggle="collapse" href="#multiCollapseTeen" role="button" aria-expanded="false"
            aria-controls="multiCollapseTeen">
            <div class="card" style="width: 15rem;">
              <img src="../../../../../public/image/undraw_reading_re_29f8.svg" class="card-img-top" alt="...">
              <div class="card-body">
          ...
          <button class="btn" data-bs-toggle="collapse" href="#multiCollapseAdult" role="button" aria-expanded="false"
            aria-controls="multiCollapseAdult">
            <div class="card" style="width: 15rem;">
          ...
          <button class="btn" data-bs-toggle="collapse" href="#multiCollapseMother" role="button" aria-expanded="false"
            aria-controls="multiCollapseMother">
            <div class="card" style="width: 15rem;">
          ...
          <button class="btn" data-bs-toggle="collapse" href="#multiCollapseOld" role="button" aria-expanded="false"
            aria-controls="multiCollapseOld">
            <div class="card" style="width: 15rem;">
