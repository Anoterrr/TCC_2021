  ...
  ?>
     ...
     <nav class="navbar shadow navbar-dark bg-primary fixed-top">
      <div class="container-fluid">
        ...
        <a class="navbar-brand nav-link" href="../../core/logout.php"><h2>Alterar Perfil</h2></a>
    ...
    <div class="config">
      <ul class="nav nav-tabs justify-content-center">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="../configuracao/vacina.php">Alterar senha</a>
        </li>
        <li class="nav-item">
