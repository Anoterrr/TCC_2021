    ...
    <div class="container">
      ...
      <div class="offcanvas offcanvas-start d-flex flex-column flex-shrink-0 p-3 bg-light" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="width: 280px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li class="nav-item">
            <a href="./configuracao/configuracao.php" class="nav-link link-dark" aria-current="page">
      ...
      <section id="vaccinationCards">
        ...
        $qtdCards = 0;
        if ($history == null) {
          echo '<div class="constainer-fluid">
            <div class="alert alert-info p-5" role="alert">Aguarde, você não possui vacinas no seu Histórico de vacinas!!</div>
            </div>';
        } else {
          foreach ($history as $dados) {
            ...
            '<small class="text-muted">' . $dados['data'] . '</small>',
            '</div>',
            '</div>';
            $qtdCards++;
          }
