    ...
    <div>
      <nav class="navbar shadow navbar-dark bg-primary fixed-top">
        <div class="container-fluid">
          ...
          <a class="navbar-brand nav-link" href="./painelAdm.php">Cadastrar Clinica</a>
      ...
      <section class="w-75 p-3 border justify-items-center justify-content-center">
        <form class="row g-3" method="POST" action="../../core/cadastroClinica.php">
          ...
          <div class="col-md-2">
            ...
            <input type="text" name="cep" onkeypress="mask_cep(this)" class="form-control" id="inputZip" maxlength="8" required />
          </div>
          <div class="col-10">
            <label for="inputAddress" class="form-label">Rua</label>
            <input type="text" name="rua" class="form-control" id="#" maxlength="100" required />
          </div>
          <div class="col-md-2">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="bairro" class="form-control" id="inputCity" maxlength="100" required />
          </div>
          <div class="col-md-4">
            <label for="inputState" class="form-label">Cidade</label>
            <input type="text" name="cidade" class="form-control" id="inputCity" maxlength="40" required />
          </div>
          <div class="col-md-2">
            <label for="inputZip" class="form-label">Uf</label>
            <input type="text" name="uf" class="form-control" id="inputZip" maxlength="2" required />
          </div>
          <div class="col-md-4">
